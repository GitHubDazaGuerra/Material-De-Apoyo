...
<title>Login usando PDO y PHP</title>
  ...
  <div class="container">
    <a class="navbar-brand" href="#">UTI-PHP</a>
...
<div class="container">
    ...
    ?>
	  ...
	  <footer>
      <hr>
        <div class="copyright"> &copy; 2021 - <?=date("Y")?> <a href="https://baulcode.com" target="_blank">FICHAS CSF</a>. All rights reserved </div>
